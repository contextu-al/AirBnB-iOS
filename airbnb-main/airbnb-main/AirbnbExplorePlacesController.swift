//
//  AirbnbExplorePlacesController.swift
//  airbnb-main
//
...
class AirbnbExplorePlacesController: BaseTableController {
...
extension AirbnbExplorePlacesController: UITableViewDataSource {
