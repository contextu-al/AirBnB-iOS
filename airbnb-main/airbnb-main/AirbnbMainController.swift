...
class AirbnbMainController: UITabBarController {
    ...
    lazy var savedController: ContextualBaseViewController = {
        let controller = ContextualBaseViewController()
    ...
    lazy var inboxController: ContextualBaseViewController = {
        let controller = ContextualBaseViewController()
    ...
    lazy var profileController: ContextualBaseViewController = {
        let controller = ContextualBaseViewController()
